...
Run `npm run dev --workspace=@earendil-works/pi-desktop` and open `http://127.0.0.1:4317`. Run `npm run spike --workspace=@earendil-works/pi-desktop` for the phase 0 capability report.
